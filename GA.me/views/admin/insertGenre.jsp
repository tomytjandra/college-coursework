		...
		<div class="container py-4">
			...
			<div class="row">
				...
				<div class="col-md-6 box-content">
					...
					<p class="text-secondary">A new Genre.</p>

					<form action="../../controllers/admin/doInsertGenre.jsp" method="POST">
						<!--Name text field-->
						...
						<!--Insert Genre button-->
						<div class="form-group">
							<input type="submit" class="btn btn-primary" value="Insert Genre">
						</div>
					</form>
				</div>
